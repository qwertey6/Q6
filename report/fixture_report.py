...
<meta name='generator' content='Q6 PSE benchmark (github.com/qwertey6/Q6)'>
<style>
...
<footer>
  Generated by <b>Q6</b> — open photosensitive-epilepsy video detection
  benchmark (github.com/qwertey6/Q6). Detector profile:
  <code>{profile_name}</code>. Standards references on individual regions
  link to the normative text.
</footer>
